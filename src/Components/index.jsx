...
class MainPage extends Component {
  ...
  render() {
    if (this.state.toslogin === true) {
      return <Navigate to="/Slogin" />; // Replaced Redirect with Navigate
    } else if (this.state.totlogin === true) {
      return <Navigate to="/Flogin" />; // Replaced Redirect with Navigate
    } else if (this.state.toalogin === true) {
      return <Navigate to="/Alogin" />; // Replaced Redirect with Navigate
    }

    return (
      <div>
        <Navbar />
        <h1 style={{ textAlign: 'center', color: 'orange', fontFamily: 'serif' }}>
          <b>EXAM SCHEDULING MANAGEMENT SYSTEM</b>
        </h1>
        <br />
        <br />
        <br />
        ...
        <div>
          <p>
            <button
              className="color-1 btn btn-1 btn-1e"
          ...
          <p>
            <button
              className="color-1 btn btn-1 btn-1c"
          ...
          <button
            className="color-3 btn btn-1 btn-1f"
